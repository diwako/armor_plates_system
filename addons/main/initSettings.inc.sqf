...
[
    ...
    _category,
    [[0, 1, 2, 3, 4, 5], [LLSTRING(downedFeedback_0), LLSTRING(audioFeedback_1), LLSTRING(audioFeedback_2), LLSTRING(audioFeedback_3), LLSTRING(audioFeedback_4), LLSTRING(audioFeedback_5)], 3],
    false
] call CBA_fnc_addSetting;
